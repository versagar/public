...
const detailedTopicsButtons = [
  {
    "label": "Topics: Beginner Coding",
    "json": "/twc/courses/topics/jsons/bcodertwc.json",
    "args": ["topicsContainer", "ttFrame1", "ttFrame2", "topicsHead"],
    "classes": "btn bg-primary pad2 text-secondary bold round2 shadow2 center"
  },
  {
    "label": "Topics: Advanced Coding",
    "json": "/twc/courses/topics/jsons/tcodertwc.json",
    "args": ["topicsContainer", "ttFrame1", "ttFrame2", "topicsHead"],
