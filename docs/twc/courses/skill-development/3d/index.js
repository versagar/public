...
const detailedTopicsButtons = [
  {
    "label": "Topics: Beginner 3D Modeling",
    "json": "/twc/courses/topics/jsons/3dbasictwc.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: Advanced 3D Modeling",
    "json": "/twc/courses/topics/jsons/3dadvancedtwc.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
