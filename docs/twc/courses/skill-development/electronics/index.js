...
const detailedTopicsButtons = [
  {
    "label": "Topics: Basic Electronics",
    "json": "/twc/courses/topics/jsons/belectronicstwc.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: Microcontrollers & IoT",
    "json": "/twc/courses/topics/jsons/ielectronicstwc.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
