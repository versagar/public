...
const detailedTopicsButtons = [
  {
    "label": "Topics: Beginner AI & ML",
    "json": "/twc/courses/topics/jsons/mlbasictwc.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: Advanced AI & Deep Learning",
    "json": "/twc/courses/topics/jsons/mladvancedtwc.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
