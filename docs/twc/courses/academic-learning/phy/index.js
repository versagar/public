...
const detailedTopicsButtons = [
  {
    "label": "Topics: Primary & Middle Physics",
    "json": "/twc/courses/topics/jsons/primaryphysics.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: Secondary \u2192 Advanced Physics",
    "json": "/twc/courses/topics/jsons/secondaryphysics.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: General / Customized Physics",
    "json": "/twc/courses/topics/jsons/generalphysics.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
