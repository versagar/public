...
const detailedTopicsButtons = [
  {
    "label": "Topics: Primary & Middle Math",
    "json": "/twc/courses/topics/jsons/primarymath.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: Secondary \u2192 Advanced Math",
    "json": "/twc/courses/topics/jsons/secondarymath.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: General / Customized Math",
    "json": "/twc/courses/topics/jsons/generalmath.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
