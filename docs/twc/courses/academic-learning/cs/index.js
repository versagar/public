...
const detailedTopicsButtons = [
  {
    "label": "Topics: Primary & Middle CS",
    "json": "/twc/courses/topics/jsons/csprimarymiddle.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: Secondary \u2192 Advanced CS",
    "json": "/twc/courses/topics/jsons/cssecondaryadvanced.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: General / Customized CS",
    "json": "/twc/courses/topics/jsons/csgeneralcustom.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
