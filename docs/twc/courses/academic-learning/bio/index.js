...
const detailedTopicsButtons = [
  {
    "label": "Topics: Primary & Middle Biology",
    "json": "/twc/courses/topics/jsons/biologyprimarymiddle.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: Secondary \u2192 Advanced Biology",
    "json": "/twc/courses/topics/jsons/biologysecondaryadvanced.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
  ...
  {
    "label": "Topics: General / Customized Biology",
    "json": "/twc/courses/topics/jsons/biologygeneralcustom.json",
    "args": [
      "topicsContainer",
      "ttFrame1",
      "ttFrame2",
